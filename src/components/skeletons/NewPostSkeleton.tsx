        ...
        <div className="flex md:hidden items-center w-full flex-col py-4">
            <div className="flex flex-col w-[85%] relative mt-6 py-2 px-4 shadow-[1px_3px_4px_0px_rgba(0,_0,_0,_0.3)] bg-[#363636] rounded-full">
                ...
                <div className="flex flex-col w-full px-2">
                    ...
                    <input type="file" id="file-input" accept="image/*, video/*, .webp" className="hidden" multiple/>
                            ...
                            <div className='w-full h-full flex gap-4 pb-2'>
                                ...
                                <div className='flex flex-col flex-grow gap-4'>  
                                    ...
                                    <div className='flex justify-end gap-4 items-center'>
                                        ...
                                        <input type="file" id="file-input" accept="image/*, video/*, .webp"  disabled className="hidden" multiple/>
                                        ...
                                        <HeroUiBtn className="relative flex h-[40px] w-28 items-center justify-center overflow-hidden bg-[#5D5E5D] rounded-full font-Roboto text-[#EFEFEF] shadow-[0px_3px_3px_0px_rgba(0,0,0,0.2)] transition-all before:absolute before:h-0 before:w-0 before:rounded-full before:bg-gray-800 before:duration-500 before:ease-out hover:shadow-none hover:before:h-56 hover:before:w-56">
              ...
              <div className="flex flex-col justify-between relative w-full min-h-fit items-center gap-4 pt-4 px-4">
                  <div className='w-full h-full flex gap-4 pb-2 '>
                      ...
                      <div className='flex flex-col flex-grow gap-4'>  
                        ...
                        <div className='flex justify-end gap-4 items-center'>
                            <div className='flex h-full justify-center items-center'>
                              <input type="file" id="file-input-pc" accept="image/*, video/*, .webp" className="hidden" multiple/>
                              <div className='flex w-full h-full items-center'>
