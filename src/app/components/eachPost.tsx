    ...
    <div className="my-2 w-[800px] h-fit flex flex-col gap-2 text-white px-1 py-2 overflow-hidden border-t-[1px] border-[#515151]">
      <div className="flex gap-2 flex-1">
        <div className='flex flex-col w-full'>
                            ...
                            <div className="flex flex-row w-fit justify-center items-center gap-4 py-4 px-4">
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <div className="flex flex-col">
                                      ...
                                      <span className="block bg-[#515151] w-[75px] h-[1px] -ml-[3px]"></span>
                                    </div>
          ...
          <div className={`flex px-4 ${(post.fileUrls?.length || 0) === 1 && isPortrait ? 'flex-row' : 'flex-col'}`}>
            ...
            {post.fileUrls?.length === 1 && isPortrait && (
                <Image
                  ...
                  width={0}
                  height={0}
                  className="w-[100%] h-full pt-2 mr-4"
                  onLoad={handleImageLoad}
                />
            )}

            {/* Paragraph content */}
            <p className={`${post.fileUrls?.length > 2 || (post.fileUrls?.length === 1 && isPortrait) ? 'pr-8' : 'pr-8'} max-w-full break-all pt-1 text-justify text-[#EFEFEF] font-normal font-Roboto`}>
              {post.content}
            </p>
                ...
                <DialogContent className='w-full h-[85vh] flex flex-col  text-black overflow-y-auto max-w-[35%]'>
                  ...
                  <ScrollArea className="rounded-md py-2 w-[100%]">
                    ...
                    <div className='flex gap-2 w-[95%] pt-4 pb-0'>
                      <button onClick={() => handleReaction(1)} disabled={isProcessing}><svg width="20" height="20" viewBox="0 0 7 7" xmlns="http://www.w3.org/2000/svg"><g clipPath="url(#clip0_57_98)"><path d="M0.0175432 3.20833L2.87879 0.259583C3.04796 0.0904165 3.26963 -1.62297e-07 3.50296 -1.52097e-07C3.73629 -1.41898e-07 3.95796 0.0904165 4.12129 0.256667L6.98254 3.20833L4.96129 3.20833L4.96129 7L2.04463 7L2.04463 3.20833L0.0175432 3.20833Z" fill={`${postReaction === 1 ? '#319357' : '#585858'}`}/></g><defs><clipPath id="clip0_57_98"><rect width="7" height="7" fill="white" transform="translate(7) rotate(90)"/></clipPath></defs></svg></button>
                      <p className={`${postReaction === 1  ? 'text-[#319357]' : 'text-[#585858]'}`}>{postLikes}</p>
                      <button onClick={() => handleReaction(-1)} disabled={isProcessing}><svg width="20" height="20" viewBox="0 0 7 7" xmlns="http://www.w3.org/2000/svg"><g id="Layer_1" clipPath="url(#clip0_57_85)"><path id="Vector" d="M6.98246 3.79167L4.12121 6.74042C3.95204 6.90958 3.73037 7 3.49704 7C3.26371 7 3.04204 6.90958 2.87871 6.74333L0.0174562 3.79167L2.03871 3.79167L2.03871 -3.88486e-07L4.95537 -2.60994e-07L4.95537 3.79167L6.98246 3.79167Z" fill={`${postReaction === -1  ? '#D25551' : '#585858'}`}/></g><defs><clipPath id="clip0_57_85"><rect width="7" height="7" fill="white" transform="translate(0 7) rotate(-90)"/></clipPath></defs></svg></button>
                      <p className={`${postReaction === -1  ? 'text-[#D25551]' : 'text-[#585858]'}`}>{postDislikes}</p>
                    </div>
