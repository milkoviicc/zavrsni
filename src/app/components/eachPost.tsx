...
const EachPost = ({post, handleLike, handleDislike, deletePost, updatePost, refreshPosts}: {post: Post, handleLike: (postId: string) => void, handleDislike: (postId: string) => void, deletePost: (postId: string) => void, updatePost: (postId: string) => void, refreshPosts: () => void})=> {
  ...
  return (
    <div className="my-2 w-full max-w-xl h-fit flex flex-col gap-2 text-black px-1 py-2 rounded-3xl overflow-hidden shadow-[0px_0px_5px_1px_rgba(0,_0,_0,_0.2)]">
            ...
            <div className="flex flex-col w-full px-4">
              <div className='flex justify-between'>
                <div className='flex gap-2 items-center'>
                  <h1 className="text-base font-Roboto font-medium">{post.userProfile.firstName} {post.userProfile.lastName}</h1>
