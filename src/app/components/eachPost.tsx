        ...
        <div className='flex flex-col w-full'>
          ...
          <div className="flex gap-4 items-center justify-between">
            <div className="flex justify-between w-full">
              <div className='flex gap-1 px-12 py-2 mt-6 items-center'>
