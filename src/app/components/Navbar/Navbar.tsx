                ...
                <div className="w-[33%] flex justify-start ml-10">
                    <button className="hover:cursor-pointer flex gap-2" onClick={() => router.push(`/my-profile`)}>
                        ...
                        <div className="flex flex-col h-full items-start justify-center gap-3">
                            ...
                            <p className="text-[#595959] leading-[5.66px]">@{user.username}</p>
                        </div>   
                    </button>
                </div>
