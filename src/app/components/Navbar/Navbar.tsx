...
export default function Navbar() {
    ...
    return (
        <div className="border-1 border-black bg-[#222222] [box-shadow:0px_0.5px_20.16px_0px_rgba(0,_0,_0,_0.26)] h-[75px] fixed top-0 w-full">
            <div className="flex justify-between items-center h-full w-full">
                <div className="w-[33%] flex justify-start ml-10">
                    <h1 className="text-4xl font-Roboto font-[900] italic text-[#D0D0D0]">SNET</h1>
                </div>
                <div className="flex w-full justify-center gap-2 items-center">
                    ...
                    <div className="w-fit relative">
                        ...
                        <Input type="text"id="searchInput" autoComplete="off" value={search} placeholder="Search something or someone..." onChange={(e) => setSearch(e.target.value)} className="bg-[#363636] font-Roboto w-[500px] text-[#BBBBBB] text-base rounded-3xl shadow-[0px_0px_3px_0.2px_rgba(0,0,0,0.35)] border focus-visible:ring-0 border-transparent "/>  
