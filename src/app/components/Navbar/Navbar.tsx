        ...
        <div className="border-1 border-black bg-white rounded-md [box-shadow:0px_0.5px_20.16px_0px_rgba(0,_0,_0,_0.26)] h-[75px] fixed top-0 w-full">
            <div className="flex justify-between items-center h-full w-full">
                ...
                <div className="w-[33%] flex justify-end gap-1 items-center">
                    <Button asChild variant="link" onClick={logout} className="hover:cursor-pointer"><FontAwesomeIcon icon={faRightFromBracket} className="text-sm -mt-1 font-thin size-6" /></Button>
