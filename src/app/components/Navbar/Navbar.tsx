            ...
            <div className="flex justify-between items-center h-full w-full">
                ...
                <div className="flex w-full justify-center gap-2 items-center">
                    ...
                    <div className="w-fit relative">
                        ...
                        <Input type="text"id="search" autoComplete="off" value={search} placeholder="Search something or someone..." onChange={(e) => setSearch(e.target.value)} className="bg-[#363636] font-Roboto w-[500px] text-[#BBBBBB] text-base rounded-3xl shadow-[0px_0px_3px_0.2px_rgba(0,0,0,0.35)] border focus-visible:ring-0 border-transparent "/>  
                ...
                <div className="w-[33%] flex justify-end gap-1 items-center">
                    <Button asChild variant="link" onClick={logout} className="hover:cursor-pointer"><FontAwesomeIcon icon={faRightFromBracket} className="text-sm -mt-1 font-thin size-6 text-[#AFAFAF]" /></Button>
