        ...
        <div className="border-1 border-black bg-[#f5f4f4] rounded-md shadow-lg h-[75px] fixed top-0 w-full">
            <div className="flex justify-between items-center h-full w-full">
                ...
                <div className="flex w-full justify-evenly">
                    ...
                    <button className={`px-0 hover: underline transition-all`} onClick={() => router.push(``)}><svg width="40" height="40" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg"><g clipPath="url(#clip0_109_78)"><path d="M9.26445 4.45607C9.26445 3.63705 8.9391 2.85156 8.35996 2.27242C7.78081 1.69328 6.99533 1.36792 6.1763 1.36792C5.35727 1.36792 4.57179 1.69328 3.99264 2.27242C3.4135 2.85156 3.08814 3.63705 3.08814 4.45607C3.08814 8.05892 1.54407 9.08831 1.54407 9.08831H10.8085C10.8085 9.08831 9.26445 8.05892 9.26445 4.45607Z" stroke="#525252" strokeWidth="0.693327" strokeLinecap="round" strokeLinejoin="round"/><path d="M7.0666 11.1471C6.97611 11.3031 6.84623 11.4326 6.68996 11.5226C6.53369 11.6126 6.35652 11.66 6.17618 11.66C5.99585 11.66 5.81867 11.6126 5.6624 11.5226C5.50614 11.4326 5.37625 11.3031 5.28577 11.1471" stroke="#525252" strokeWidth="0.693327" strokeLinecap="round" strokeLinejoin="round"/></g><defs><clipPath id="clip0_109_78"><rect width="12.3526" height="12.3526" fill="white" transform="translate(0 0.338501)"/></clipPath></defs></svg>{path === '/chat' ? <span className="block bg-black border-black h-[1px]"></span> : null}</button>
                    <button className={`px-0 hover: underline transition-all`} onClick={() => router.push(``)}><svg width="40" height="40" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M10.9622 6.17924C10.9639 6.84958 10.8073 7.51086 10.5051 8.10921C10.1467 8.82622 9.59582 9.4293 8.91408 9.8509C8.23234 10.2725 7.44669 10.496 6.64512 10.4963C5.97477 10.498 5.3135 10.3414 4.71515 10.0392L1.82019 11.0042L2.78518 8.10921C2.48295 7.51086 2.32633 6.84958 2.32808 6.17924C2.32839 5.37767 2.55186 4.59201 2.97346 3.91028C3.39506 3.22854 3.99814 2.67764 4.71515 2.3193C5.3135 2.01707 5.97477 1.86045 6.64512 1.8622H6.89906C7.95768 1.9206 8.95755 2.36742 9.70724 3.11711C10.4569 3.86681 10.9038 4.86668 10.9622 5.92529V6.17924Z" stroke="#525252" stroke-width="0.653468" stroke-linecap="round" stroke-linejoin="round"/></svg>{path === '/notification' ? <span className="block bg-black border-black h-[1px]"></span> : null}</button>
                </div>
                <div className="w-full flex justify-end">
                    <Button asChild variant="link" size="icon" onClick={logout} className="uppercase mr-10"><FontAwesomeIcon icon={faGear} size="xs" className="px-1 -mt-1" /></Button>
                </div>
