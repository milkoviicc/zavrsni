...
const EachReply = ({reply, like, dislike, deleteReply}: {reply: Reply, like: (commentReplyId: string) => void, dislike: (commentReplyId: string) => void, deleteReply: (commentReplyId: string) => void}) => {
            ...
            <div className='flex flex-col w-full ml-4'>
                <div className='flex justify-between mr-2'>
                    <div className='flex gap-2 items-center'>
                        <h1 className="text-base font-Roboto">{reply.userProfile.firstName} {reply.userProfile.lastName}</h1>
