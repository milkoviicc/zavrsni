            ...
            <div className='flex flex-col w-full ml-4'>
                <div className='flex justify-between mr-2'>
                    <div className='flex gap-2 items-center'>
                        <h1 className="text-base font-Roboto text-[#EFEFEF]">{reply.userProfile.firstName} {reply.userProfile.lastName}</h1>
                ...
                <div>
                    <p className='max-w-full break-all pr-4 ml-4 list-item font-Roboto text-[#EFEFEF]'>{reply.content}</p>
                </div>
