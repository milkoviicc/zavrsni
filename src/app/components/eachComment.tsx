          ...
          <div className='flex-col w-full ml-4'>
            <div className='flex justify-between mr-2'>
              <div className='flex gap-2 items-center'>
                <h1 className="text-base font-Roboto text-[#EFEFEF]">{comment.user.firstName} {comment.user.lastName}</h1>
            ...
            <div className='flex gap-1 items-center'>
              ...
              <Dialog open={isCommentReplyDialogOpen} onOpenChange={setIsCommentReplyDialogOpen}>
                ...
                <DialogContent className='w-full h-[350px] flex flex-col bg-[#222222] overflow-y-auto max-w-[90%] lg:max-w-[45%] lg:min-w-fit'>
                  <DialogHeader className='flex flex-row gap-2'>
